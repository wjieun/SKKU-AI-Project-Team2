...
def classify_hand_image(hand_img, hand_mask):
    hand_img = cv2.imread(hand_img)
    mask_img = cv2.imread(hand_mask)
    ...
    return (head_pred_class, life_pred_class, heart_pred_class)